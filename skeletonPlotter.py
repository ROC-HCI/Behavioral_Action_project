...
def unittest1():
    data,dataheader=fio.readdatafile('Data/13.3.csv')
    boneconnection = fio.readskeletaltree('Data/KinectSkeleton.tree')[1]
...
# Plot a sequence of joint coordinates
def unittest7():
    data1,head,bones = fio.readorients('/Users/itanveer/Data/ROCSpeak_BL/allSkeletons/57.2.csv')
    data3,head,bones = fio.readorients('/Users/itanveer/Data/ROCSpeak_BL/allSkeletons/31.1.csv')
    data = fio.vcat(data1,data3)
    plt.plot(data[:,5:9])
    plt.show()
